"""
Main IgniterDesigner class for torch igniter design.

This module orchestrates the complete igniter design process,
...
from .chamber import size_chamber_from_mass_flow
from .nozzle import size_nozzle_from_mass_flow
from .performance import calculate_all_performance_metrics
...
class IgniterDesigner:
    ...
    def get_combustion_sweep(
        ...
        """Sweep mixture ratio to find performance envelope.
        ...
        """
        return self.cea.sweep_mixture_ratio(
            mr_min=mr_min,
            mr_max=mr_max,
            chamber_pressure_pa=config.chamber_pressure,
