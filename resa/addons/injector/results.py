...
class FluidProperties:
    ...
    def __repr__(self) -> str:
        return (f"FluidProperties(rho={self.density:.2f} kg/m3, "
...
class PerformanceMetrics:
    ...
    def summary(self) -> str:
        ...
        lines = [
            "Performance Metrics:",
            f"  Spray half angle:        {self.spray_half_angle:.2f} deg",
...
class ColdFlowResults:
    ...
    def summary(self) -> str:
        ...
        return (
            ...
            f"  Liquid density:    {self.liquid_density:.2f} kg/m3\n"
            f"  Gas density:       {self.gas_density:.2f} kg/m3"
        )
