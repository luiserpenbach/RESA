...
export function SuggestedValuesPanel({ config, result }: SuggestedValuesPanelProps) {
  ...
  useEffect(() => {
    ...
    Plotly.newPlot(lstarRef.current, data as Plotly.Data[], layout as Partial<Plotly.Layout>, PLOTLY_CONFIG);
  ...
  useEffect(() => {
    ...
    Plotly.newPlot(crRef.current, data as Plotly.Data[], layout as Partial<Plotly.Layout>, PLOTLY_CONFIG);
