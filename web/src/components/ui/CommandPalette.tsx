...
export function CommandPalette({ onRunDesign, onValidate, onExportYaml }: CommandPaletteProps) {
  ...
  const allCommands: Command[] = [
    ...
    },
    {
      ...
      desc: "Switch to engine cross-section view",
      icon: "diagram-tree",
      action: () => { setWorkspaceTab("schematic"); setCmdPaletteOpen(false); },
      group: "View",
    },
    {
      id: "view-dashboard",
      label: "View Dashboard",
      desc: "Switch to performance dashboard plots",
      icon: "dashboard",
    ...
    {
      id: "view-contour",
      label: "View Nozzle Contour",
      desc: "Switch to contour and gas dynamics view",
      icon: "timeline-line-chart",
      action: () => { setWorkspaceTab("contour"); setCmdPaletteOpen(false); },
      group: "View",
    },
    {
      id: "view-3d",
      label: "View 3D Model",
      desc: "Switch to 3D nozzle viewer",
      icon: "cube",
      action: () => { setWorkspaceTab("3d"); setCmdPaletteOpen(false); },
      group: "View",
    },
    {
      id: "nav-engine",
