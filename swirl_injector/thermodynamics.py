...
try:
    ...
    print("Warning: CoolProp not available. Using approximate property values.")
...
FALLBACK_PROPERTIES = {
    ...
    'nitrousoxide': {
        'density': 45.0,  # kg/m³ (gas at high temp)
...
class ThermodynamicCalculator:
    ...
    def get_propellant_properties(
        ...
        if 'ethanol' in fuel.lower():
            fuel_chamber.surface_tension = cls.get_surface_tension_mixture(
